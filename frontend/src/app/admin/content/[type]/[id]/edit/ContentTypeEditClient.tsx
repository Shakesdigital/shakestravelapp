...
export default function ContentTypeEditClient() {
  ...
  const typeLabel = typeLabels[type as keyof typeof typeLabels] || 'Content';
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center space-x-3">
            ...
            <HelpTooltip content={`Edit your ${typeLabel.toLowerCase()} content with rich editing features.`} />
          </div>

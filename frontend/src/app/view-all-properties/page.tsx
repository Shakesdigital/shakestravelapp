...
const ViewAllPropertiesPage: React.FC = () => {
  ...
  const heroImages = [
    ...
    { title: 'Mountain Retreats', subtitle: 'Escape to Uganda\'s scenic highlands', image: '⛰️' }
  ];
  ...
  const hasActiveFilters = () => {
    return filters.category !== 'all' || filters.searchQuery;
  };
                      ...
                      <Link href={`/accommodations/${accommodation.slug}`}>
                        ...
                        <div className="relative h-48 overflow-hidden">
                          ...
                          {accommodation.originalPrice && accommodation.originalPrice > accommodation.price && (
                            <div className="absolute top-4 right-4 bg-red-500 text-white px-2 py-1 rounded-full text-xs font-semibold">
                              {accommodation.discount || `Save $${accommodation.originalPrice - accommodation.price}`}
                            </div>
                          )}
                        </div>
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex justify-between items-center">
                            <span className="text-xs text-green-600 font-medium">{accommodation.availability}</span>
